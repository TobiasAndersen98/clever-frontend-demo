    ...
    <>
      <div className={cn('relative flex flex-col', className)}>
        <input
          ...
          {...props}
          className={cn(
            'font-roboto h-12 tracking-body-large pl-4 text-base text-[#003732] bg-transparent border-[1px] border-[#668784] focus:outline-none focus:border-[#003732] peer',
      ...
      {error && <p className="text-[#E2284D] mt-1 text-[11px] leading-[140%]">{error}</p>}
    </>
  )
);
